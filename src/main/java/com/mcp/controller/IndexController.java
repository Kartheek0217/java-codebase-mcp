...
public class IndexController {
    ...
    @Operation(
        summary = "Get project index statistics", 
        description = "Returns counts of indexed files and AST symbols for a specific project. Useful for verifying index completeness.",
        responses = {
    ...
    @Operation(
        summary = "Manually trigger directory scan", 
        description = "Forces the system to re-scan the project root directory and update the index with any new or modified files.",
        responses = {
    ...
    @Operation(
        summary = "Reconcile database with filesystem", 
        description = "Performs a deep sync to remove database entries for files that no longer exist on disk and update entries for modified files.",
        responses = {
    ...
    @Operation(
        ...
        description = "Finds indexed files whose paths match the provided search query (case-insensitive substring match).",
        responses = {
    ...
    @Operation(
        summary = "Search file content (Lucene)", 
        description = "Performs high-performance full-text search across all indexed files using Lucene. Returns matching lines and context.",
        responses = {
