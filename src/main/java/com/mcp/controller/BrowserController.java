...
public class BrowserController {
    ...
    @PostMapping("/session")
    @Operation(summary = "Create browser session", description = "Initializes a new headless browser context.")
    ...
    @GetMapping("/session")
    @Operation(summary = "List browser sessions", description = "Returns a list of all active or historical browser sessions.")
    ...
    @Operation(summary = "Close browser session", description = "Terminates the browser context and cleans up resources.")
    ...
    @Operation(summary = "Navigate to URL", description = "Navigates the browser to the specified web address.")
    ...
    @Operation(summary = "Take screenshot", description = "Captures a screenshot of the current page as a base64 encoded string.")
    ...
    @Operation(summary = "Click element", description = "Performs a mouse click on the element matching the selector.")
    ...
    @Operation(summary = "Fill input field", description = "Sets the value of an input field matching the selector.")
    ...
    @Operation(summary = "Type text", description = "Types text character-by-character into the element matching the selector, simulating real keystrokes.")
    ...
    @Operation(summary = "Select dropdown option", description = "Selects an option by value from a <select> element matching the selector.")
    ...
    @Operation(summary = "Wait for selector", description = "Waits until an element matching the selector appears in the DOM.")
    ...
    @Operation(summary = "Execute JavaScript", description = "Runs a script within the context of the page.")
    ...
    @Operation(summary = "Get page content", description = "Retrieves the current page URL, title, and HTML content.")
