...
public record ContentSearchResult(@Schema(description = "Relative or absolute path to the file") String filePath,
		@Schema(description = "Title of the document (if available)") String title,
